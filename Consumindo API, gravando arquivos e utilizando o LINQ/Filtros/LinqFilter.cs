...
internal class LinqFilter
{
    ...
    {
        var artistasPorGeneroMusical = musicas.Where(musica => genero == musica.Genero!.Contains(genero)).Select(musica => musica.Artista).Distinct().ToList();
    ...
    {
        var musicasEmCSharp = musicasEmCSharp.Where(musica => musica.Tonalidade.Equals("C#")).Select(musica => musica.Nome).ToList();
